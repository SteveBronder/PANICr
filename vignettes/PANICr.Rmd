...
library(PANICr)
data("NIPA_agg_5")
agg1.04 <- panic04(NIPA_agg_5, nfac = 12,k1 = 7,criteria = "BIC3")
```
...
```{r}
agg1.10.d <- panic10(NIPA_agg_5,nfac = 12, k1 = 7,criteria = "BIC3",demean = TRUE)
```
...
```{r}
agg1.10.nd <- panic10(NIPA_agg_5,nfac = 12, k1 = 7,criteria = "BIC3",demean = FALSE)
```
